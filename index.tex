...
\hypersetup{
  pdftitle={Da neofita della programmazione funzionale a campione},
...
\title{Da neofita della programmazione funzionale a campione}
\usepackage{etoolbox}
\makeatletter
...
\part{La teoria delle categorie}

\chapter{La categoria}\label{la-categoria}
